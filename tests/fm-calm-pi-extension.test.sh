...
JS
  ...
  hash_before=$(fm_test_sha256 "$session_file") || fail "could not hash the Pi session file"
...
JS
  ...
  hash_after=$(fm_test_sha256 "$session_file") || fail "could not hash the Pi session file"
