...
// 140s on Windows so the budget stays above arm's MSYS confirm default (120s
// in bin/fm-watch-arm.sh): a slow but successful Git Bash cold start must not
// be SIGTERMed mid-confirmation. Conditioned on win32 so other platforms keep 12s.
const ARM_READY_TIMEOUT_DEFAULT_MS = process.platform === "win32" ? 140000 : 12000;
