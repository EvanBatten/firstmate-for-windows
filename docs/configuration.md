...
`bin/fm-session-start.sh`'s header is the single owner of session-start ordering, composed commands, digest contents, the early home-operable marker, and the digest's startup mechanism.
