...
FM_CLAUDE_AUTOARM_FIRST_CLAIM_WAIT_MS=15000   # milliseconds a home that has never claimed waits on its first turn end; this is not the measured-window cap
