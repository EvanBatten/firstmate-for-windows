...
For a feature represented by a `tools/fm-control` trace, load `control-firstmate` and use its one-command real-session driver instead of adding another sleep-polling shell scenario.
