...
- `control-firstmate` - load before writing or running a captain trace for `tools/fm-control/drive.mjs`, and before proving or timing a firstmate behavior against a live primary in a throwaway home.
