...
- `control-firstmate` - load before writing or running a firstmate session trace, and when a feature claim must be proven or disproven by one `tools/fm-control/drive.mjs` command.
